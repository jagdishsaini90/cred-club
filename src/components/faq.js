    ...
    <>
      <div className="w-screen relative bg-[radial-gradient(63.85%_195.77%_at_50.93%_100%,_rgb(17,17,17)_0%,_rgb(0,0,0)_100%)] border-t border-b border-t-[rgba(255,255,255,0.3)] border-b-[rgba(255,255,255,0.3)] border-l-0 border-r-0">
        <div
          ...
          className="font-[gilroy] cursor-pointer h-[20vh] text-[30px] font-medium leading-[39.33px] tracking-[8.4px] flex justify-center items-center text-[rgba(255,255,255,0.7)]"
        >
        ...
        >
          <div className="text-white text-center px-[100px] py-[150px] flex flex-col">
            <div className="text-white text-left text-[31px] font-semibold leading-[36px] tracking-[0.1px] font-[gilroy]">
              how can I add my cards on CRED?
            </div>
            <div className="text-white text-left text-[22px] font-medium leading-[40px] tracking-[-0.2px] opacity-60 font-[gilroy] mt-[60px]">
              {
            ...
            <div className="text-white text-left text-[31px] font-semibold leading-[36px] tracking-[0.1px] font-[gilroy] mt-[60px]">
